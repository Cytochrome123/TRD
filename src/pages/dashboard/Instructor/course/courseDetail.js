        ...
        <table className="w-full table-auto min-w-max x-overflow-scroll ">
            ...
            <tbody>
                ...
                students.map((student, index) => (
                    ...
                    <td className="px-4 py-2 ">
                        <div className='relative flex justify-between h-8 text-blue-500 cursor-pointer hover:underline' onClick={() => navigate(`/instructor/dashboard/assigned-course/${course._id}/student/${student._id}`)}>
